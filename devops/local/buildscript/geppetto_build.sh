...
APPLICATION='/jacksonlearning_3372'
...
DESKTOPCODE='../../../application/client/desktop/jacksonlearning_3372'
DESKTOPIMAGENAME='geppettotest/jacksonlearning_3372-desktop:1.0'
...
helm install --name jacksonlearning_3372 ./helm
if [ $? -eq 0 ]; then
